...
<div id="pw_bar">
	...
	<form method="post">
		<button onclick="GotoPage( this, '/messages/' );"><?php echo $newMessages; ?> Messages</button>
		<button onclick="GotoPage( this, '/home/' );">Home</button>
		<button onclick="GotoPage( this, '/account/' );">My Account</button>
		<button onclick="GotoPage( this, '/logout/' );">Logoff <?php echo $_SESSION['USER']; ?></button>
	</form>
	<?php } ?>
</div>
